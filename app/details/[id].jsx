  ...
  <View style={styles.container}>
    ...
    <Pressable style={styles.favoriteButton} onPress={handleFavorite}>
      <Animated.View style={[animatedHeartStyle]}>
          ...
          <AntDesign name="heart" size={28} color={favorite ? "#dc5e5eff" : "#76cd4dff"} />
    ...
    <View style={styles.imageContainer}>
      {/* Hero image */}
      <Image source={{ uri: attraction.thumbnail }} style={styles.heroImage} />
    ...
    >
      <View style={styles.mapContainer}>
        ...
        <Pressable style={styles.closeButton} onPress={() => setShowMap(false)}>
